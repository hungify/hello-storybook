...
function Radio({ label, ...restProps }: RadioProps) {
  return (
    <Field {...restProps}>
      {({ input, meta }) => (
        <StyledLabel>
...
function RadioGroup({ name, label, children, required, ...restProps }: RadioGroupProps) {
  ...
  return (
    <FieldWrapper {...restProps}>
      ...
      <div style={{ position: 'relative' }}>
        {React.Children.map(children as React.ReactElement<RadioGroupProps>, (child) =>
